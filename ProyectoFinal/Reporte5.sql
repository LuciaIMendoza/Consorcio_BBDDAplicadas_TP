...
BEGIN
    ...
    SELECT TOP 3
        ...
        SUM(ISNULL(ec.saldo, 0) + ISNULL(ec.InteresesPorMora, 0)) AS TotalAdeudado_Pesos,
        ROUND(SUM(ISNULL(ec.saldo, 0) + ISNULL(ec.InteresesPorMora, 0)) / @DolarBlue, 2) AS TotalAdeudado_Dolares,
